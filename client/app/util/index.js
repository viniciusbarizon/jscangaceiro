System.register(['./Bind.js', './ConnectionFactory.js', './DaoFactory.js', './ApplicationException.js', './HttpService.js', './ProxyFactory.js', './decorators/Debounce.js', './decorators/Controller.js', './Required.js', './decorators/BindEvent.js'], function (_export, _context) {
  "use strict";
  ...
  return {
    setters: [function (_BindJs) {
      ...
      for (var _key9 in _RequiredJs) {
        if (_key9 !== "default" && _key9 !== "__esModule") _exportObj9[_key9] = _RequiredJs[_key9];
      }
